...
const QuickWinView: React.FC<QuickWinViewProps> = ({ analysis }) => {
  ...
  const toolInfo: any = {
    copilot: { name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', icon: 'Ⓜ️' },
    gemini: { name: 'Google Gemini', url: 'https://gemini.google.com', icon: '🌐' },
    chatgpt: { name: 'ChatGPT Plus', url: 'https://chat.openai.com', icon: '⚡' }
  };
    ...
    <div className="max-w-4xl mx-auto p-6 md:p-12 pb-32 animate-in slide-in-from-bottom-10 duration-1000">
      <Card className="p-16 relative overflow-hidden border-2 border-gray-100">
        <div className="text-center">
            <div className="text-5xl mb-6">{currentTool.icon}</div>
